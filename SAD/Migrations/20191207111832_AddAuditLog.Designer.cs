...
namespace SAD.Migrations
{
    ...
    [Migration("20191207111832_AddAuditLog")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SAD.Model.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("SAD.Model.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SAD.Model.ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("SAD.Model.AuditLog", b =>
                {
                    b.HasOne("SAD.Model.Room", "Room")
                        .WithMany()
                        .HasForeignKey("RoomId");

                    b.HasOne("SAD.Model.CardOwner", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
                });
            ...
            modelBuilder.Entity("SAD.Model.Card", b =>
                {
                    b.HasOne("SAD.Model.CardOwner", "CardOwner")
                        .WithMany("Cards")
